...
import { Check, Sparkles, Users, Gift, Calendar, Clock, MessageCircle, ArrowRight, Star, Zap, BookOpen, Video, Phone } from 'lucide-react';

export default function ThankYouFreePageMuaKhoaHoc() {
    useEffect(() => {
    ...
    const whatYouGet = [
        {
            ...
            text: "Khoá học online và sự đồng hành hỗ trợ của giảng viên"
        },
        {
            ...
            <div className="relative z-10 container mx-auto px-4 py-12 md:py-20">
                ...
                <div className="text-center mb-12 animate-fade-in">
                    ...
                    <p className="text-xl md:text-2xl text-text-main font-semibold mb-3">
                        Đăng ký thành công khóa học AI Kiến Trúc Nội thất
                    </p>
                ...
                <div className="max-w-4xl mx-auto mb-12">
                    ...
                    <div className="text-center text-lg text-text-main leading-relaxed">
                        {whatYouGet.map((item, index) => (
                            <span key={index} className="inline-flex items-center gap-2">
                                {index > 0 && <span className="mx-2">•</span>}
                                <span className="inline-flex items-center gap-2 text-primary">{item.icon}</span>
                                <span>{item.text}</span>
                            </span>
                        ))}
                    </div>
                ...
                <div className="max-w-3xl mx-auto mb-12">
                    <div className="bg-gradient-to-br from-bg-surface to-bg-main border border-primary/20 rounded-2xl p-8 md:p-10 shadow-xl">
                        <div className="flex items-start gap-4 mb-6">
                            ...
                            <div className="flex-1">
                                <h3 className="text-2xl font-bold font-heading mb-3 text-text-main">
                                    Trợ lý sẽ gọi điện tư vấn cho bạn
                                </h3>
                                <p className="text-text-main text-lg mb-4 leading-relaxed">
                                    Chúng tôi sẽ liên hệ với bạn trong thời gian sớm nhất để tư vấn chi tiết về khóa học.
                                ...
                                <div className="bg-primary/10 border border-primary/30 rounded-xl p-4">
                                    <p className="text-text-main font-semibold mb-2">
                                        Hoặc bạn có thể gọi trực tiếp để được tư vấn ngay lập tức:
                                    </p>
                                    <a
                                        href="tel:0936340576"
                                        className="inline-flex items-center gap-3 text-xl font-bold text-primary hover:text-accent transition-colors group"
                                    >
                                        <Phone className="h-5 w-5 group-hover:scale-110 transition-transform" />
                                        <span>Ms Hiên: 0936340576</span>
                                    </a>
                                </div>
                            </div>
                        </div>
