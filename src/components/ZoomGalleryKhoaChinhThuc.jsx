...
export function ZoomGalleryKhoaChinhThuc() {
    return (
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="text-center mb-12 max-w-4xl mx-auto">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-heading text-text-main mb-6 leading-tight">
                        Kết quả ngay trong khoá học
                    </h2>

                    <p className="text-text-main text-xl md:text-2xl font-sans font-semibold leading-relaxed">
                        Hãy xem những <span className="text-primary font-bold">kết quả to lớn</span> mà học viên đạt được <span className="text-primary font-bold underline decoration-2 underline-offset-4">dưới đây</span>
                    </p>
                </div>
                ...
                <div className="text-center mb-12 max-w-4xl mx-auto">
                    ...
                    <p className="text-text-muted text-lg">
                        Được tạo ra ngay trong khoá học này
                    </p>
                </div>
                ...
                <div className="mt-20 text-center">
                    ...
                    >
                        <span className="relative z-10 flex items-center gap-3">
                            Đăng ký ngay khoá học <ArrowRight className="h-6 w-6 group-hover:translate-x-1 transition-transform" />
                        </span>
